...
export default function Notes() {
  const courseRepositories = [
        ...
        description: "This course will provide students in the Engineering program with the ability to appropriately incorporate selected economic and business practices into the practice of engineering.",
        repository: "https://github.com/alexxlevesque/course-notes/tree/main/apsc221-engineering_economics",
        topics: ["Microeconomics", "Case Studies", "Cash Flow Analysis", "Financial Statements"],
          ...
          <section className="mb-16">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {courseRepositories.map((repo) => (
                ...
                >
                  <h3 className="text-lg font-semibold text-navy-900 dark:text-blue-100 mb-2">
                    {repo.title}
                  </h3>
                  <p className="text-navy-700 dark:text-blue-200 text-sm mb-4">
                    {repo.description}
                  </p>
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-xs text-navy-600 dark:text-blue-300">
                      Completed: {repo.dateCompleted}
                    </span>
                    <a
