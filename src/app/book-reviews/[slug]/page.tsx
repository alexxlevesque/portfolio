      ...
      <main className="min-h-screen pb-20 pt-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white dark:bg-navy-800 rounded-lg shadow-lg p-6">
            <div 
              className="prose prose-lg max-w-none dark:prose-invert prose-headings:text-navy-900 dark:prose-headings:text-white prose-p:text-navy-700 dark:prose-p:text-blue-200 prose-strong:text-navy-900 dark:prose-strong:text-white prose-ul:text-navy-700 dark:prose-ul:text-blue-200 prose-li:text-navy-700 dark:prose-li:text-blue-200"
