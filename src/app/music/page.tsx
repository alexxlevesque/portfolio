                ...
                <div className="relative pl-6 border-l-2 border-space_cadet/20 space-y-10">
                    {timeline.map((item, i) => (
                        <div key={i} className="relative">
                            {/* Dot on the timeline */}
                            <div className="absolute -left-[25px] top-1 w-3 h-3 rounded-full bg-space_cadet border-2 border-isabelline" />
                    ...
                    {songs.map((song, i) => (
                        ...
                        >
                            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                                {/* Track number */}
                                <div className="shrink-0 w-10 h-10 rounded-lg bg-space_cadet flex items-center justify-center text-white text-sm font-bold">
            ...
            <section className="space-y-6">
                ...
                <div className="flex flex-wrap gap-6 text-sm text-pale_dogwood uppercase tracking-wider font-medium">
                    <a
                        ...
                        className="hover:text-space_cadet transition-colors inline-flex items-center gap-1.5"
                    >
