  ...
  return (
    <main className="min-h-screen max-w-3xl mx-auto px-4 sm:px-6 py-24">
      <header className="mb-12">
        ...
        <p className="mt-2 text-sm text-ultra-violet">applied math & computer engineering @ queen's university</p>
      ...
      <section className="mb-10">
        <h2 className="text-sm uppercase tracking-widest text-ultra-violet">academics</h2>
      ...
      <section className="mb-10">
        <h2 className="text-sm uppercase tracking-widest text-ultra-violet">internships</h2>
      ...
      <section className="mb-10">
        <h2 className="text-sm uppercase tracking-widest text-ultra-violet">key projects</h2>
        <div className="mt-3 space-y-3 text-[15px] leading-7">
          ...
          <p>&gt; 2025 — stock ml prediction for price forecasting —
            <a href="https://github.com/alexxlevesque/stockpriceprediction-rf" target="_blank" rel="noopener noreferrer" className="underline ml-1">github</a>
            <span className="block text-rose-quartz">multi-factor model, technical indicators, backtesting, risk assessment.</span>
          </p>
