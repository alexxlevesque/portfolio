...
export default function ThemeToggle() {
  ...
  useEffect(() => {
    // Check if user has a theme preference, default to dark if not set
  ...
  return (
    <button
      onClick={toggleTheme}
      className="fixed top-2 right-8 p-2 rounded-full bg-gray-200 dark:bg-gray-800 transition-colors duration-200 z-50"
